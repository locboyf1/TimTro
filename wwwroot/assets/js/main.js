...
(function ($) {
    ...
    $("#price-range").slider({
        ...
        slide: function (event, ui) {
            $("#priceRange").val("[" + ui.values[0].toLocaleString('vi-VN') + " - " + ui.values[1].toLocaleString('vi-VN') + "] VNĐ");
        }
    });
    $("#priceRange").val("[" + $("#price-range").slider("values", 0).toLocaleString('vi-VN') + " - " + $("#price-range").slider("values", 1).toLocaleString('vi-VN') + "] VNĐ");
    ...
    $("#price-range-P").slider({
        ...
        values: [50, 1000000],
        slide: function (event, ui) {
            $("#priceRangeP").val("[ $" + ui.values[0].toLocaleString('en-US') + " - $" + ui.values[1].toLocaleString('en-US') + " ]");
        }
    });
    $("#priceRangeP").val("[ $" + $("#price-range-P").slider("values", 0).toLocaleString('en-US') + " - $" + $("#price-range-P").slider("values", 1).toLocaleString('en-US') + " ]");

    //room size 1
    $("#roomsize-range").slider({
        range: true,                  // Thanh trượt với hai điểm
        min: 0,                       // Giá trị nhỏ nhất (0 m²)
        max: 150,                    // Giá trị lớn nhất 
        step: 1,                    // Bước nhảy 
        values: [0, 100],          // Giá trị mặc định 
        slide: function (event, ui) {
            // Hiển thị giá trị nguyên trực tiếp
            $("#roomsizeRange").val("[" + ui.values[0] + " - " + ui.values[1] + "] m²");
        }
    });

    // Hiển thị giá trị mặc định
    $("#roomsizeRange").val("[" + $("#roomsize-range").slider("values", 0) + " - " + $("#roomsize-range").slider("values", 1) + "] m²");
